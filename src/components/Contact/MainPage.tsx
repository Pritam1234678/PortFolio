        ...
        <div className="sm:w-[75%] md:w-[60%] mx-auto">
          ...
          <div className="flex justify-end">
            <motion.div variants={appear} initial="initial" animate="animate" className="w-[70%] sm:w-[60%] md:w-[55%]">
              <Paragraph text="I’m always here and happy to connect — feel free to reach out! Whether you have a project in mind, a question, or just want to say hello, I’d love to hear from you." />
            </motion.div>
          </div>
          <div className="mt-14">
