...
import AboutImage1 from "../../../public/images/general/about/pp1.png";
    ...
    <section className="mt-[5vh]">
      ...
      >
        ...
        <div className="flex-1">
          <div>
            <Paragraph
              text="With over months of
            experience, I've developed websites from the
            ground up, satisfying both design and development an essential thing
            for my eyes."
            />
          </div>
          <div className="mt-6">
            <Paragraph text="For a bit more background, I was born in Bankura, WestBengal and grew up there. I currently study in India as a second-year college student, where I balance my academics with a deep interest in programming." />
          </div>
        </div>
        <div className="flex-1 mt-6 md:mt-0 hidden">
          <div>
