...
import Image2 from "@../../../public/images/general/home/process_image2.png";
        ...
        <div className="flex-1" ref={imageRef}>
          ...
          <div className="mt-10 mb-[6vh] flex md:mt-6 md:mb-0">
            ...
            <div className="flex-[2]">
              <Paragraph text="Welcome, and thank you for visiting my portfolio! I invite you to explore my projects and see the journey I've been on as a developer and learner. Each section reflects my dedication, creativity, and growth. I hope you find something that inspires or amazes you as you scroll through my work." />
            </div>
          </div>
        </div>
        <div className="flex-[1.5]">
          <motion.div className="object-cover object-top overflow-hidden z-[0]">
            <div className="">
              <Image
                src={Image2}
